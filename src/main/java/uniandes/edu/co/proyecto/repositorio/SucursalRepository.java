...
public interface SucursalRepository extends JpaRepository<Sucursal, Integer> {
        ...
        @Query(value = "SELECT DISTINCT S.* " +
                        ...
                        "WHERE (P.nombre = :producto OR P.codigo_barras = :codigo_barras) AND I.total_existencias > 0", nativeQuery = true)
         Collection<Sucursal> darSucursalesConProducto(@Param("producto") String producto, @Param("productoId") Integer codigo_barras);
